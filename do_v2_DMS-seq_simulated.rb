...
enzymes = ["v2test_DMS-seq_simulated"]
...
##	system("cp /Data03/fli/DMS-seq/base_human/* /Data03/fli/DMS-seq/#{enzyme}/")
##	system("cp /Data03/fli/DMS-seq/v2_DMS-seq_simulated/*.reads /Data03/fli/DMS-seq/#{enzyme}")
####	#	generate simulated reads
####	loci.each { |locus|
####		system("./generate_simulated_reads_v2_DMS-seq.R /Data03/fli/DMS-seq/#{enzyme}/#{locus}.known.rnafold #{uds} #{vds} 15 40 #{num_reads} /Data03/fli/DMS-seq/#{enzyme}/#{locus}.DMS.collapsed.reads")
####	}
...
##	loci.each { |locus|
##		pid = fork do
##			exec("perl RNASeqFold.pl -rmin 15 -rmax 40 -n 100000 -burn_in 10000 -samp 100 -t sd -m 2 -numCPU 1 -outdir /Data03/fli/DMS-seq/#{enzyme}/ /Data03/fli/DMS-seq/#{enzyme}/#{locus}.DMS.collapsed.reads /Data03/fli/DMS-seq/#{enzyme}/#{enzyme}.DMS.v2b.rates /Data03/fli/DMS-seq/#{enzyme}/#{locus}.starting_points.rnafold")
##		end
##	}
##	Process.waitall
...
#		system("ruby get_posterior_distribution_dinucl.rb /Data03/fli/DMS-seq/#{enzyme}/#{locus}.mcmc.001.txt s 10000 100 > /Data03/fli/DMS-seq/#{enzyme}/#{locus}.posterior.001.txt")
		system("ruby get_posterior_distribution_dinucl.rb /Data03/fli/DMS-seq/#{enzyme}/#{locus}.starting_points.mcmc.001.txt d 10000 100 > /Data03/fli/DMS-seq/#{enzyme}/#{locus}.parameters.001.txt")

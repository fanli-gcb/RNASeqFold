...
loci = ["NM_003234_validated_region", "NM_005080_validated_region", "NM_016332_validated_region"]
enzymes = ["v2test_K562vivoMerge_mc2000", "v2test_K562vivoMerge_mc500"]
...
enzymes.each { |enzyme|
	...
	system("cp /Data03/fli/DMS-seq/K562vivoMerge/*.reads /Data03/fli/DMS-seq/#{enzyme}/")
	system("cp /Data03/fli/DMS-seq/base_human/*.Boltzmann_starts.rnafold /Data03/fli/DMS-seq/#{enzyme}/")
